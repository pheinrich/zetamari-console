...
// COSTING_INCLUDE lives in db/costingInclude.js, not here - a 'use
// server' file (this one) can only export async functions (Next
// rejects the whole module otherwise), and COSTING_INCLUDE is a plain
// array. Only imported for this file's own use below; other callers
// (e.g. scheduling.js) import it from db/costingInclude.js directly.
