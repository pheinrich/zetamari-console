// Overlay of width/height dimension callouts (arrows + labels) drawn on
...
{
  return (
    <line x1={start} y1={y} x2={end} y2={y} stroke={color} strokeWidth='0.5' />
  )
}
...
{
  return (
    <line x1={x} y1={start} x2={x} y2={end} stroke={color} strokeWidth='0.5' />
  )
}
...
{
  return (
    <text x={x} y={y} dominantBaseline='middle' textAnchor='middle' fill='black'>
