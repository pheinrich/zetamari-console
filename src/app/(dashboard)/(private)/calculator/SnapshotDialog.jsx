...
// Exports the current MirrorView preview as a PNG at an arbitrary target
// width. Ported from the old console app essentially as-is - this is DOM/
// canvas manipulation, not tied to any framework component.
export default function SnapshotDialog( {imageRef} )
{
  ...
  function downloadImage( width )
  {
    ...
    img.onload = (e) => {
      ...
      canvas.getContext( '2d' ).drawImage( e.target, 1, 1, canvas.width - 2, canvas.height - 2 )

      let anchor = document.createElement( 'a' )
      anchor.download = 'mirror-calculator.png'
